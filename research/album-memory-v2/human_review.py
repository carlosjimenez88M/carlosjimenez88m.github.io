"""Policy-blinded 48-item human review packet; no fabricated human labels."""
import random,html
from prepare import *
def main():
 rows=read(OUT/'runs.json')
 sample=[r for r in rows if r['policy']=='full' or (r['policy']=='adaptive' and r['threshold']==3)]
 ...
 print('Prepared 48 blinded items; no human labels generated.')
