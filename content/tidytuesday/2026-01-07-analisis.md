...
description: A Vector Narrative Arc Approach
...
`Natural Language Processing` `Embeddings` `Literary Analysis` `Data Science` `Machine Learning` `Text Mining` `Computational Literature`
